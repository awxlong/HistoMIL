...
python3 HistoMIL/Notebooks/mil_inference.py --exp-name 'mil-inference-transmil-resnet50' \
...
python3 HistoMIL/Notebooks/mil_inference.py --exp-name 'mil-inference-attentionmil-resnet50' \
                                            --project-name 'g0-arrest-inference-resnet50-binary' \
                                            --wandb-entity-name 'anwangxuelong' --localcohort-name 'COAD' \
                                            --task-name 'g0_arrest' --pid-name 'PatientID' \
                                            --targets-name 'g0_arrest' \
...
python3 HistoMIL/Notebooks/mil_inference.py --exp-name 'mil-inference-transformer-resnet50' \
                                            --project-name 'g0-arrest-inference-resnet50-binary' \
                                            --wandb-entity-name 'anwangxuelong' --localcohort-name 'COAD' \
                                            --task-name 'g0_arrest' --pid-name 'PatientID' \
                                            --targets-name 'g0_arrest' \
...
python3 HistoMIL/Notebooks/mil_inference.py --exp-name 'mil-inference-camil-resnet50' \
                                            --project-name 'g0-arrest-inference-resnet50-binary' \
                                            --wandb-entity-name 'anwangxuelong' --localcohort-name 'COAD' \
                                            --task-name 'g0_arrest' --pid-name 'PatientID' \
                                            --targets-name 'g0_arrest' \
...
python3 HistoMIL/Notebooks/mil_inference.py --exp-name 'mil-inference-dtfdmil-resnet50' \
                                            --project-name 'g0-arrest-inference-resnet50-binary' \
                                            --wandb-entity-name 'anwangxuelong' --localcohort-name 'COAD' \
                                            --task-name 'g0_arrest' --pid-name 'PatientID' \
                                            --targets-name 'g0_arrest' \
...
python3 HistoMIL/Notebooks/mil_inference.py --exp-name 'mil-inference-graphtransformer-resnet50' \
                                            --project-name 'g0-arrest-inference-resnet50-binary' \
                                            --wandb-entity-name 'anwangxuelong' --localcohort-name 'COAD' \
                                            --task-name 'g0_arrest' --pid-name 'PatientID' \
                                            --targets-name 'g0_arrest' \
