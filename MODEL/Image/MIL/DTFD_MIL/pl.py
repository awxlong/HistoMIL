...
class pl_DTFD_MIL(BaseMIL):
    ...
    def _create_model(self):
        """
        Create and return the DTFD-MIL model.
        """
    ...
    def forward(self, x):
        """
        Forward pass for DTFD-MIL. Overrides BaseMIL.forward to return multiple outputs.
        """
    ...
    def training_step(self, batch, batch_idx):
        """
        Training step for DTFD-MIL. Overrides BaseMIL.training_step to handle manual optimization and gradient accumulation.
        """
    ...
    def validation_step(self, batch, batch_idx):
        """
        Validation step for DTFD-MIL. Overrides BaseMIL.validation_step to handle custom validation logic.
        """
    ...
    def infer_step(self, batch):
        """
        Inference step for DTFD-MIL. Overrides BaseMIL.infer_step to handle custom inference logic.
        """
        self.model.classifier.eval()
        self.model.dimReduction.eval()
        self.model.attention.eval()
