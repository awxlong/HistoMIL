...
from HistoMIL.MODEL.Image.MIL.TransformerRegression.model import TransformerRegression
from HistoMIL.MODEL.Image.MIL.utils import  get_loss, get_optimizer, get_scheduler

import pdb
class pl_TransformerRegression(pl.LightningModule):
    def __init__(self, paras:TransformerRegressionParas):
        super().__init__()
        self.paras = paras
        self.model = TransformerRegression(paras)
