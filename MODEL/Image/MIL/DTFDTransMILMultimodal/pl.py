...
from HistoMIL.MODEL.Image.MIL.DTFDTransMILMultimodal.model import DTFDTransMILMultimodal
...
class pl_DTFDTransMILMultimodal(pl.LightningModule):
    def __init__(self, paras:DTFDTransMILMultimodalParas):
        super().__init__()
        self.automatic_optimization = False
        self.paras = paras
        self.model = DTFDTransMILMultimodal(paras)# 
    ...
    def configure_optimizers(self):
        trainable_parameters = list(self.model.TransMILMultimodal.parameters())
    ...
    def training_step(self, batch, batch_idx):
        ...
        with torch.cuda.amp.autocast():
            inputs, clinical_feats, _, labels = batch  # 
    ...
    def validation_step(self, batch, batch_idx):
        self.model.TransMILMultimodal.eval()
