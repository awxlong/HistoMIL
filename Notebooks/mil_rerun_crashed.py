...
from args import get_args_mil_rerun
...
def run_mil_rerun(args):
    ...
    exp.setup_cv_experiment(last_cv=args.last_cv, main_data_source="slide",
                            need_train=True)
