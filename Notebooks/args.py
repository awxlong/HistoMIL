...
def get_args_mil():
    ...
    parser.add_argument("--efficient-finetuning", type=str2bool, nargs='?', const=True, default=False, 
                    help="Set True to enable finetuning mlp_head and first input projection layer (default: True) only for Transformer")
    parser.add_argument(
        "--seed", type=int, default=42, help="Seed to ensure reproducibility")
    parser.add_argument(
    ...
    parser.add_argument(
        "--train", action="store_true", help="Use this flag for performing training within CV framework")
    parser.add_argument(
        "--inference", action="store_true", help="Use this flag for performing inference")
    parser.add_argument(
        "--interpretability", action="store_true", help="Use this flag for performing interpretability analysis")
    parser.add_argument(
