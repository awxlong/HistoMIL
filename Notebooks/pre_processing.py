...
(also called tiling or tessellation) and feature extraction with 
foundation models UNI and Prov-Gigapath.

We also enable the computation of weighted adjacency matrices for the WSIs 
following the protocol in https://arxiv.org/abs/2305.05314 to enable
graph-based MIL.
...
# ## specify gigapath
# python HistoMIL/Notebooks/pre_processing.py --exp-name 'preprocessing-debug' --project-name 'g0-arrest' 
# --wandb-entity-name 'cell-x' --localcohort-name 'CRC' --task-name 'g0-arrest' 
# --pid-name 'PatientID' --targets-name 'g0_arrest' --cohort-dir '/Users/awxlong/Desktop/my-studies/hpc_exps/' 
# --split-ratio 0.99 0.01 --step-size 224 --backbone-name 'prov-gigapath'
